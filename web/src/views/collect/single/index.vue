<template>
  <page-view>
    ...
    <single-collect-form @register="registerModal" @save-success="handleSuccess" />
  </page-view>
</template>

<script setup lang="ts">
import { getSingleList, deleteSingle } from "@/api/collect";
import { TableColumnProps } from "@/components/Table";
import singleCollectForm from "./form.vue";
